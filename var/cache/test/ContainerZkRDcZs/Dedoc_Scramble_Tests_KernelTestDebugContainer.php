 ...
 */
class Dedoc_Scramble_Tests_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Dedoc\\Scramble\\Http\\Controllers\\DocsController' => 'getDocsControllerService',
    ...
    protected static function getControllerResolverService($container)
    {
        ...
        $instance->allowControllers(['Dedoc\\Scramble\\Tests\\Kernel', 'Dedoc\\Scramble\\Http\\Controllers\\DocsController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Dedoc_Scramble_Tests_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ScrambleBundle' => 'Dedoc\\Scramble\\ScrambleBundle',
            ],
            ...
            'kernel.container_class' => 'Dedoc_Scramble_Tests_KernelTestDebugContainer',
